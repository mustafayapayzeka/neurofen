      ...
      <div style={{ position:"relative", zIndex:1, paddingBottom:80 }}>
        ...
        <div style={{ padding:"18px 20px 14px", borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ width:36, height:36, borderRadius:10, background:"linear-gradient(135deg,#4fc3f7,#9c64f0)", display:"flex", alignItems:"center", justifyContent:"center", display:"flex", alignItems:"center", justifyContent:"center" }}> <svg width="36" height="36" viewBox="-90 -90 180 180" xmlns="http://www.w3.org/2000/svg">   <text x="0" y="28" fontFamily="Georgia,serif" fontSize="115" fontWeight="700" fill="#6a1fc2" textAnchor="middle" opacity="0.55">N</text>   <text x="0" y="28" fontFamily="Georgia,serif" fontSize="115" fontWeight="700" fill="none" stroke="#9c64f0" strokeWidth="2" textAnchor="middle" opacity="0.7">N</text>   <path d="M-6,18 C-6,38 -28,46 -34,33 C-44,40 -48,26 -40,16 C-48,6 -40,-6 -29,1 C-27,-18 -13,-22 -6,-9 Z" fill="rgba(79,195,247,0.12)" stroke="#4fc3f7" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>   <path d="M6,18 C6,38 28,46 34,33 C44,40 48,26 40,16 C48,6 40,-6 29,1 C27,-18 13,-22 6,-9 Z" fill="rgba(156,100,240,0.12)" stroke="#9c64f0" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round"/>   <circle cx="0" cy="-48" r="5" fill="#66bb6a"/>   <ellipse cx="0" cy="-48" rx="22" ry="8" fill="none" stroke="#66bb6a" strokeWidth="1.8"/>   <ellipse cx="0" cy="-48" rx="22" ry="8" fill="none" stroke="#4fc3f7" strokeWidth="1.8" transform="rotate(60,0,-48)"/>   <ellipse cx="0" cy="-48" rx="22" ry="8" fill="none" stroke="#9c64f0" strokeWidth="1.8" transform="rotate(-60,0,-48)"/> </svg> </div></div>
            <div>
                  ...
                  {[
                    ...
                    { id:"gelistirici", ikon:"👤", baslik:"Geliştirici / Akademisyen", renk:"#9c64f0",
                      icerik: <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                        ...
                        <div>
                          <div style={{ fontSize:13, fontWeight:600, color:"#fff" }}>Doç. Dr. Mustafa Ergun</div>
