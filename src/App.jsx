      ...
      <div style={{ position:"relative", zIndex:1, paddingBottom:80 }}>
        ...
        <div style={{ padding:"18px 20px 14px", borderBottom:"1px solid rgba(255,255,255,0.06)" }}>
          <div style={{ display:"flex", alignItems:"center", gap:10 }}>
            <div style={{ width:36, height:36, borderRadius:10, background:"linear-gradient(135deg,#4fc3f7,#9c64f0)", display:"flex", alignItems:"center", justifyContent:"center", fontSize:16 }}>🧠</div>
            <div>
